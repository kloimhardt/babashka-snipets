(function() {
    ...
    function continueStory() {
        ...
        while(story.canContinue) {
            ...
            if(paragraphText.substr(0,2) == ":b") {
                // special :b feature by KLM
                var pElement = document.createElement('p');
                pElement.innerHTML = "<strong>" + paragraphText.substr(3, paragraphText.length) + "</strong>";
                storyContainer.appendChild(pElement);
                showAfter(delay, pElement);
                delay += 200.0;
            } else {
