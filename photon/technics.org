...
*** personal note
talk is from 2012, maybe the tone vis a vis Java is harsh and maybe other languages have taken up the points presented in favour of Clojure on the JVM. In particular the endorsement of Groovy over Clojure is very honest and worth noticing.

"So I think if you're just interested in dynamic and want to continue to write programs that are like your Java programs, Groovy can can't be touched"
"Clojure is about realizing what's wrong with your Java programs and doing something different"
