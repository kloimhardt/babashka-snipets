...
*** clj Files
**** Command lines
clj -Sdeps "{:deps {org.scicloj/clay {:mvn/version \"2-beta15\"}}}" -M  babashka-snipets/stefan.clj

clj -Sdeps "{:deps {org.scicloj/clay {:mvn/version \"2-beta15\"} com.nextjournal/beholder {:mvn/version \"1.0.2\"} org.mentat/emmy {:mvn/version \"0.32.0\"}}}" -M babashka-snipets/mariastefan.clj
...
(clay/make! {:source-path "babashka-snipets/stefan.clj"})
  ...
  (do
    ...
    (defn make! [_] (clay/make! {:format      [:html] #_ [:quarto :pdf]
                                 :source-path "babashka-snipets/mariastefan.clj"}))
