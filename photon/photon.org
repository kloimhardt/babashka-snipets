...
https://archive.org/details/naturalphilosoph032159mbp (auch Calibre)
...
Äther und Relativitätstheorei (in Calibre)
Über den Äther (in Calibre)
...
https://martinezwritings.com/m/Kinematics.html
Abstract: T62.00002 : How Einstein Was Influenced by the Philosopher Arthur Schopenhauer
(University of Texas at Austin)
Vortrag 7.3.24, Abstract via google scholar:
...
Don Howard, A Peek behind the veil of maya, in: The Cosmos of Science
enthält Referenzen zu
Friedrich Herneck 1969, ...
Cassierer: Determinismus und Indeterminismus in der modernen Physik
https://archive.org/details/zurmodernenphysi0000cass/page/n7/mode/1up

** Lorentz

Versuch einer Theorie der electrischen und optischen Erscheinungen in bewegten Körpern
https://de.wikisource.org/wiki/Versuch_einer_Theorie_der_electrischen_und_optischen_Erscheinungen_in_bewegten_Körpern
...
https://de.wikisource.org/wiki/Elektromagnetische_Erscheinungen

Electromagnetic phenomena in a system moving with any velocity smaller than that of light
H.A. Lorentz, Proc. K. Ak. Amsterdam 6, 809 (1904), Collected Papers, Vol.5, p172
(in google scholar)

Paper zu Lorentz
Lorentz, Poincaré, Einstein, and the Genesis of the Theory of Special Relativity
https://arxiv.org/pdf/2510.17838
mit Hinweis auf wichtige historische Zusammenfassung von Lorentz von Gans:
Gans, Richard. “H. A. Lorentz. Elektromagnetische Vorgänge in einem Systeme, das sich mit einer willkürlichen Geschwindigkeit (kleiner als die des Lichtes) bewegt.” Beiblätter zu den Annalen der Physik 29, no. 4 (1905): 168–170.
...
C.R. Ac.Sci. Paris 140, 1504 (1905), Oevres, Vol. 9, p489
Rend. Circ. Mat. Palermo 21, 129 (1906); Oevres, Vol 9, p494

** Feynman
Space-Time Approach to Non-Relativistic Quantum Mechanics
https://authors.library.caltech.edu/47756/1/FEYrmp48.pdf

Quantum Mechanics and Path Integrals Emended Edition (Dover -- Richard P Feynman, Albert R Hibbs, and Daniel F Styer (in Calibre)
"a particularly illuminating application of the path integral is the derivationof the frequency ω and wave number k⃗ of the de Broglie wave representing a particle with energy E and momentum p⃗. See Feynman and Hibbs, page 45." (Zee, QFT fast as possible p111)
...
** Schrödinger
erste Mitteilung:
https://people.isy.liu.se/jalar/kurser/QF/references/Schrodinger1926a.pdf
S372: Es ist nicht ausgemacht, dass dieselbe [neue Fassung] in ihren Ergebnissen ein blosser Abklatsch der üblichen Quantentheorie sein wird. Z.B. führt das relativistische Keplerproblem, wenn man es genau nach der eingangs gegebenen Vorschrift durchrechnet, merkwürigerweise auf halbzahige Teilquanten (Radial- und Azimutquant)

S374: ... die Bohrsche Frequenzbedingung selbst scheinbar den Charakter einer Näherungsformel erhält. Das ist aber nur scheinbar und wird völlig vermieden, wenn man die relativistische Theorie entwickelt, durch welche überhaupt erst ein tieferes Verständnis vermittelt wird. Die grosse additive Konstante C hängt natürlich aufs innigste zusammen mit der Bahnenergie mc^2 des Elektrons.
Auch das nochmalige und unabhängige Auftreten der Konstante h in der Frequenzbedingung wird durch die relativistische Theorie aufgeklärt bzw. vermieden. Aber leider begegnet ihre einwandfreie Durchführung vorläufig noch gewissen, oben berührten Schierigkeiten
...
G. N. Ord
https://iopscience.iop.org/article/10.1088/1742-6596/361/1/012007/pdf

https://www.researchgate.net/profile/Garnet-Ord/publication/342783525_Can_Minkowski_Spacetime_Resolve_Quantum_Superposition/links/5f05e86c299bf188160a6825/Can-Minkowski-Spacetime-Resolve-Quantum-Superposition.pdf
...
-> as google AI: "how differential forms specifically simplify Maxwell's relations"

Simplest way:
https://statisticalphysics.leima.is/thermodynamics/summary.html

Beginners Guide to Differential Forms in Thermodynamics
https://www.fuw.edu.pl/~pzdybel/DiffF.pdf

Differential forms for plasma physics, 13.1.2020 (jounal paper)
R. S. MacKay
"differential forms are only the antisymmetric covariant tensors"

*** Bücher:
Differential Forms with Applications to the Physical Sciences, Harley Flanders, 1963, 89
https://www.math.u-szeged.hu/~stacho/mm/flanders.pdf

Global Analysis: Differential Forms in Analysis, Geometry, and Physics, Ilka Agricola, Thomas Friedrich, 2002
Aus Amazon: Bott and Tu’s “Differential Forms in Algebraic Topology,” Frankel’s “The Geometry of Physics, 3rd Ed.,” Abraham, Marsden and Ratiu’s “Manifolds, Tensor Analysis, and Applications,” and Choquet-Bruhat, DeWitt-Morette, and Dillard-Bleick’s “Analysis, Manifolds and Physics, Revised Ed.”
...
Viorel Badescu
Modeling Thermodynamic Distance, Curvature and Fluctuations: A Geometric Approach (Understanding Complex Systems), May 27, 2016, ISBN: 9783319337883
-> harte Nuss

Classical and Geometrical Theory of Chemical and Phase Thermodynamics
Frank Weinhold ISBN: 978-0-470-43505-2 February 2009
-> scheint einfacher

Geometrothermodynamics
Hernando Quevedo
Research Article| January 23 2007
" We show that Weinhold’s metric, which was introduced ad hoc, is not contained within this invariant set. "

Fundamentals of Geometrothermodynamics
Hernando Quevedo, Maria N. Quevedo
21 Nov 2011
https://arxiv.org/abs/1111.5056

** Relativistic Hamilton Mechanics

Foundations of Mechanics by Ralph Abraham and Jerrold E. Marsden (2002)

Valter Moretti, 2023, Analytical Mechanics: Classical, Lagrangian and Hamiltonian Mechanics, Stability Theory, Special Relativity

Oliver Johns, 2016, Analytical Mechanics for Relativity and Quantum Mechanics
Entwickelt wohl die relativistische Mechanik nach Lanzcos

Greiner 2 und Greiner+Struckmeier

Geometric Formulation of Classical and Quantum Mechanics (2010) Giovanni Giachetta [hat viel QM und fiber bundels]

Relativistic Classical Mechanics and Electrodynamics by Martin Land and Lawrence P. Horwitz. -- Classical Relativistic Many-Body Dynamics  2011 M.A. Trump (Autor), W.C. Schieve (Autor)
[Stückelberg Interpretation 8n dimensionen in phase space,]
[beide in Calibre, kommen mir dubios vor]

Cline hat kurzen Abschnitt über Greiner und Struckmeier
...
Yourgrau's Variational Principles in Dynamics and Quantum Theory
...
Zee: Quantum Field Theory, as Simply as Possible (in Calibre)
 Darin empfohlen: Mark Srednicki: QFT

Textbuch Rebhahn gibt zu dass noch nicht jeder Mathematische Zweig genau ausgetüftelt ist in der QFT: p364, Verweis aufp344 Gl.10.124

* CLJ-Tiles Brilliant manual Clay
...
** The Scribe
more like medieval copist than an original book writer.

** Clay and Quarto
schreibe:
*** fdg intro (lagrange notation) and chapter 1 in clay in scittle-kitchen and sidebar ;
*** show also in python/quarto video;
*** then greiner und struckmeier to clay/scittle

* Variational Principles of Mechanics
** Warum L = T - V
Euler und Lagrange haben Integral(T*dt, p1, p2) berechnet. Und zwar für konservative Systeme E = T + V = const. Die Integralgrenzen sind Raumpunkte, keine Zeitpunkte. D.h. T(s), t(s) und auch p1(s1) und p2(s2) sind alle von einem Parameter s abängig, der für die Ausführung der Integration nötig ist. Im Speziellen ist die Zeit t(s) abhängig von diesem Parameter, das dt ist also nicht unabhängig von s.
Wenn man das s explizit einführt kann die Zeit t eliminiert werden. Dann, kommt man auf die Form Integral(sqrt(E-V)*ds, s1, s2) das von Jacobi gefunden wurde.
Dieses Jacobi Integral entspricht formal dem Fermat Integral(n*ds, s1, s2). Die Zeit spielt keine Rolle in diesen beiden Integralen.
Hamilton hat die Zeit wieder als unabhängigen Parameter eingeführt, dann schaut das Euler/Lagrange Integral so aus: Integral(T-V * dt, t1, t2). Es ist mathematisch äquivalent. Es ziegt sich, dass damit ach nicht-konservative Systeme gerechnet werden können.

Aus der Einleitung Seite 20, die nicht ganz klar ist ohne Kommentar in []
----------------
For this purpose we let the particle move along the tentative path in accordance with the energy principle [Erhaltung der Enegrie E = T+ V]. The sum of the kinetic and potential energies is kept constant and always equal to that value E which the actual motion has revealed at time t1. This restriction assigns a definite velocity to
any point of our path and thus determines the motion. We can choose our path [in space] freely, but once this is done the conservation of energy determines the motion [in time] uniquely.

In particular, we can calculate the time at which the particle will pass an arbitrarily given point of our fictitious path and hence the time-integral of the vis viva i.e., of double the kinetic energy, extended over the entire motion from P1 to P2.
[Integral(T*dt, p1, p2) wird konkret Integral(T(s)*t(s)*ds, s1=0, s2)], was Action, eine Funktion f(s) genannt wird.]

This time integral is called “action.” It has a definite
value for our tentative path and likewise for any other tentative path, these paths being always drawn between the same two end-points P1, P2 and
always traversed with the same given energy constant E. [The various paths each take a different respective time.]

In Hamilton’s procedure we again start with the given initial point P1
and the given end-point P2.
In Hamiltions method [Integral(T-V * dt, t1, t2)] we require now is that our tentative motion shall start at the observed time t1 of the actual motion and end at the observed time t2. [in between we vary the motion in time freely; time during motion is -- contrary to Euler/Lagrange -- at our disposal].
(This condition [start at t1, end at t2]] is not satisfied in the procedure of Euler-Lagrange, because there the energy theorem restricts the motion, and the time taken to go from P1 to P2 in the
tentative motion will generally differ from the time taken in the actual motion.)
---------------

Aus Chapter V, Section 6, Summary
-----------
[For conservative systems], the [explicit] elimination of the time [by substitution] as an ignorable coordinate gives a new principle which determines only the path of the mechanical system, not the motion in time. This is Jacobi's principle which is analogous to Fermat’s principle in optics.
The same [i.e. Jacobi's] principle can be formulated as the “principle of least action.” In the latter [Euler/Lagrange], the time-integral of double the kinetic energy is minimized with the auxiliary condition that both actual and varied motions shall satisfy the energy theorem during the motion. If this principle is treated by the λ-method, the resulting equations are the Lagrangian equations of motion.
----------

** Warum Hamiltion besser als Lagrange

Chapter VII, Section 1
--------------
The position coordinates of Lagrangian mechanics are the quantities qi. The Lagrangian equations of motion remain invariant with respect to arbitrary point transformations of these coordinates. [qi = f(q1, ..., qn)]

The Hamiltonian equations are superior to the Lagrangian equations in their transformation properties is that the number of variables is doubled [q and p]. If at first sight this increase seems more of a loss than a gain, the procedure of coordinate transformations turns the liability into an asset. It is of great advantage that we can widen the realm of possible transformations by having a larger number of variables at our disposal.

Instead of a point transformation which connects the [old] qi and [the new coordinates] Qi without involving the pi, we widen the functional relation between the coordinates
by letting the momenta participate in the transformation of the position coordinates.

In Lagrangian mechanics the significant function is the Lagrangian function L [which depends only on q and its derivative q^dot], and this function is the difference between the kinetic energy and the potential energy. If we try to simplify the potential energy the kinetic energy may get too complicated, and vice versa. It is rather difficult to simplify simultaneously the potential and the kinetic energy. In Hamiltonian mechanics the situation is much more favourable because the significant function, the Hamiltonian H, does not contain any derivatives, but only the variables [q and p] themselves. Hence, it is comparable with the potential energy of the Lagrangian problem.

The kinetic energy [...] does not participate in the transformation problem. It does determine the general class of transformations [for q and p] which can be employed, but staying within that class we can focus our attention entirely on the Hamiltonian function H.

in Lagrangian mechanics we do not possess any systematic method for the simplification of the Lagrangian function. We may hit on ignorable variables by lucky guesses, but there is no systematic way of producing them. In Hamiltonian mechanics a definite method can be devised for the systematic production of ignorable variables and the simplification of the Hamiltonian function. This method [...] reduces the entire integration problem to the finding of one fundamental function [called S], the generating function of a certain transformation.

We do not think of the qi and pi as functions of the time t. We forget completely about
the equations of motion and consider the qi, pi merely as variables, They are
the coordinates of a point of the phase space and nothing else. The specific problem of motion is entirely eliminated. However, it is important that our transformation shall preserve the canonical equations.
--------------

** holonomic, non-holonomic kinematical consditions
Kinematical conditions, auxilary conditions,  Zwangsbedingungen
holonomic: f(q1, ..., qn) = 0 <=> D1f*dq1 + ... + Dnf * dqn = 0
non-holonomic: A1*dq1 + ... + An*dqn = 0

Such kinematical conditions, which can be given only as relations between the differentials of the coordinates and not as finite relations between the coordinates themselves, were called by Hertz “non-holonomic”

** monogenic, polygenic forces
polygenic: friction

This book adopts the name “monogenic” (which means “single-generated”) as a distinguishing name for this category of forces, while forces which are not derivable from a scalar function—such as friction—can be called “polygenic”.

holonomic kinematical conditions are mechanically equivalent to monogenic forces

** Scleronomic and rheonomic
rheonomic: f(q1, ..., qn, t) = 0
...
in a scleronomic system the “total energy” of the system remains constant during the motion

Rheonomic systems are within the scope of the analytical approach.
[But concerning] kinetic energy, it will not come out as a purely quadratic form of the generalized velocities; we obtain additional new terms which are linear in the
velocities, and others which are independent of the velocities.

holonomic auxiliary conditions are mechanically equivalent to monogenic forces. We can add that scleronomic holonomic conditions are equivalent to conservative monogenic forces.

** ingnorable = kinosthenic
certain variable q_k does not appear in the Lagrangian function, although q^dot_k is
present.
absent coordinates, kinosthenic, speed coordinates, cyclic variables, ignorable variables

** Hamilton's principle
Hamilton's principle holds for arbitrary mechanical systems which are characterized by monogenic forces and holonomic auxiliary conditions. The conservative nature of these forces and auxiliary conditions—i.e. their independence of the time—is not required.

Hamilton’s principle and d’Alembert’s principle are mathematically equivalent and their scopes are the same as long as the impressed forces which act on the mechanical system are monogenic.

For polygenic forces the transformation of d’Alembert’s principle into a minimum—or strictly speaking stationary value—principle is not possible.
...
phillip kerr das wittgenstein programm: philosophischer Krimi
Hörspiel ARD: https://hoerspiele.dra.de/detailansicht/1395057
...
*** other
Fantasy vs SciFi: Fantasy element are familiar (dragon, sorcery). SciFi must be narrated slowly, elements are new.
...
** Das Gasthaus in dem der Gast vom Kellner nicht zu unterscheiden ist
...
Your name is Emanuelle Kurt, but you changed to Immanuel at the age of 22 as you consider this to be closer to Hebrew origins.

As your servant is not in today, you are going to eat at Wulff's Canteen. The inn is next to the university where you inhabit the Lehrstool for the Philosophy of Music. The univerity, named after Archbishop Markus Sittikus, has been founded in 1622. It will cease to exist in 1810 when the free state of Saalsperk joins the Eastern Empire.
Saalsperk lies where the Saalach river leaves the alps and meanders across the state-borders to open out into the Eastern river.
From your window looking south and southwest, you can see the villages of Obersaalsberg and Untersberg located atop two hills carrying the same names.
You prefer to walk rather than take the horse carridge.

*** Limerik
Gaci:
Es hatte Herr Kant das Begehren
Seinen Darm elegant zu entleeren
Ein Pfeiferl geraucht
Einmal kurz angetaucht
Der Darminhalt konnt sich nicht wehren

Ich:
nach dem pfeiferl trank er noch tee
zu vertreiben jedes übrige wehweh
doch dann noch im morgenmantel 
fuhr er auf wie die tarantel
hatt er doch vergessen auf das toupe

und dann zurück in seiner schreibunterkunft
hat er erst so richtig aufgetrumpft
denn dort schrieb er nieder
auf jahr und tag immer wieder
seine Kritik der reinen Vernunft

doch um neun wurds schon spät
da legt er nieder das schreibgerät
denn bei solchem Talent
wartete schon jeder Student
auf seine Lesung an der Universität
